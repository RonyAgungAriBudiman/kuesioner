<section class="py-0" id="home">
  ...
  <div class="container">
    <div class="row align-items-center min-vh-md-75 mt-7">
      <div class="col-md-9 col-lg-9 py-6 text-sm-start text-center">
        <h1 class="mt-6 mb-sm-4 display-4 fw-light lh-sm fs-4 fs-lg-6 fs-xxl-7"><span class="text-primary">Kuesioner</span><br class="d-block d-lg-none d-xl-block" />PT. Smart Meter Indonesia</h1>
        <p class="mb-5 fs-1 lh-lg">Selamat datang di portal kuesioner PT. Smart Meter Indonesia</p>
        <!-- <a class="btn btn-lg btn-primary hover-top btn-glow" href="index.php?m=<?php echo acakacak("encode", "daftar") ?>">Pendaftaran
