    ...
    <div class="container">
        <div class="row align-items-center min-vh-md-75 mt-7">
            <div class="col-md-7 col-lg-6 py-6 text-sm-start text-center">
                <h1 class="mt-6 mb-sm-4 display-4 fw-light lh-sm fs-4 fs-lg-6 fs-xxl-7">PPDB <span class="text-primary">Online</span><br class="d-block d-lg-none d-xl-block" />Yayasan Pendidikan Islam Darul Ulum</h1>
                <p class="mb-5 fs-1 lh-lg">Selamat datang di portal penerimaan peserta didik baru (PPDB Online) </p>
