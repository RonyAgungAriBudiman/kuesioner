    ...
    <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
      <ul class="navbar-nav mx-auto pt-2 pt-lg-0  font-base">
        ...
        ?>
          ...
          <li><a class="nav-link <?php if ($_GET["p"] == "YmlST0docnJoaVdrb0IvOEtnS3FxZz09") {
                                    echo 'fw-medium active';
                                  } ?>" href="index.php?p=<?php echo acakacak("encode", "kuesioner") ?>">Kuesioner</a></li>
          <!-- <li><a class="nav-link <?php if ($_GET["p"] == "MGdXdjBBQldRcFErOUM2MlJScS92dz09") {
                                        echo 'fw-medium active';
